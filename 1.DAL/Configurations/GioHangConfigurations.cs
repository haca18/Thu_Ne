    ...
    internal interface GioHangConfigurations:IEntityTypeConfiguration<GioHang>
    {
        public void Configure(EntityTypeBuilder<GioHang> builder)
        {
            ...
            builder.Property(p => p.NgayThanhToan).HasColumnName("NgayThanhToan").
                 HasColumnType("varchar(30)").IsRequired(); // varchar(30) not null
            builder.Property(p => p.NgayTao).HasColumnName("NgayTao").
                HasColumnType("varchar(30)").IsRequired(); // varchar(30) not null
            builder.Property(p => p.TenNguoiNhan).HasColumnName("TenNguoiNhan").
               HasColumnType("varchar(30)").IsRequired(); // varchar(30) not null
            builder.Property(p => p.Sdt).HasColumnName("SdtKhanh").
               HasColumnType("varchar(30)").IsRequired(); // varchar(30) not null
            builder.Property(p => p.TrangThai).HasColumnName("TrangThai").
               HasColumnType("int").IsRequired(); // varchar(30) not null
